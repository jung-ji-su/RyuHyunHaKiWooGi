...
일상 기록, 일정 공유, 감정 나누기, 편지 주고받기까지 — 우리만의 작은 공간입나다
...
"앱스토어에 없어도 괜찮아요 — 우리만 쓰면 되니까요."<br/>
기존 커플 앱들의 광고, 데이터 수집, 불필요한 소셜 기능이 싫었습니다.<br/>
그래서 우리만을 위한 프라이빗 웹앱을 직접 만들었습니다. 

01 프라이버시가 전부다<br/>
Firebase Anonymous Auth 기반으로 두 사람만 접근 가능한 완전 폐쇄형 공간을 구축했습니다. 우리 기록은 우리만 봅니다. <br/>
02 감정을 데이터로 기록한다<br/>
감정 온도계로 매일의 기분을 1~100도로 기록하고, 주간/월간 트렌드를 자동 생성합니다. 감정도 분석하면 패턴이 보입니다. <br/>
03 재미없으면 안 쓴다<br/>
쿠폰 룰렛, confetti 파티클, 하트 팡 효과 등 사용할 때마다 즐거운 인터랙션을 설계했습니다. 지금도 매일 실사용하며 지속적으로 개선하고 있습니다. <br/>
